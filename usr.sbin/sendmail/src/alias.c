...
#ifndef lint
#ifdef NEWDB
static char sccsid[] = "@(#)alias.c	5.28 (Berkeley) 12/5/91 (with NEWDB)";
#else
#ifdef DBM
static char sccsid[] = "@(#)alias.c	5.28 (Berkeley) 12/5/91 (with DBM)";
#else
static char sccsid[] = "@(#)alias.c	5.28 (Berkeley) 12/5/91 (without DBM)";
#endif
#endif
#endif /* not lint */
/*

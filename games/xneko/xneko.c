 ...
 *	disco	!D!!X11 ./games/xneko/SCCS/s.xneko.c/%K%+%k!&%"8.1P%$%6!<
 *
 ...
 *!!System (Machine):
 *
 *!!!!K\@(#)xneko.c	8.1m%0%i%`$NF0:n$r3NG'$7$?%7%9./games/xneko/SCCS/s.xneko.c`9=@.$O0J2<$NDL$j!#
 *
...
/*
 *	X11 G- 0C11/15/19^129W18:45:52!%$%k0lMw!'
 *
 *		"icon.xbm"		!D!!%"%$%3%s
 *		"cursor.xbm"		!D!!%+!<%=%k
...
#define	BITMAP_WIDTH		32	/* #1%-%c%i%/%?$NI} (15:34:40/%;%k) */
#define	BITMAP_HEIGHT		32	/* #1%-%c%i%/%?$N9b$5 (15:34:40/%;%k) */

#define	WINDOW_WIDTH		320	/* %&%#%s8.1&$NI} (15:34:40/%;%k) */
#define	WINDOW_HEIGHT		256	/* %&%#%s8.1&$N9b$5 (15:34:40/%;%k) */
...
/*--------------------------------------------------------------
 *
 *	G-0\F0./games/xneko/SCCS/s.xneko.c9%H!J5/31/93P14670MQ!K
 *
 *--------------------------------------------------------------*/

...
#ifndef lint
#ifdef NEWDB
static char sccsid[] = "@(#)alias.c	5.29 (Berkeley) 12/8/91 (with NEWDB)";
#else
#ifdef DBM
static char sccsid[] = "@(#)alias.c	5.29 (Berkeley) 12/8/91 (with DBM)";
#else
static char sccsid[] = "@(#)alias.c	5.29 (Berkeley) 12/8/91 (without DBM)";
#endif
#endif
#endif /* not lint */
/*

...
#ifndef lint
static char sccsid[] = "@(#)xneko.c	5.2 (Berkeley) 5/22/91";
#endif /* not lint */
 ...
 *!!Introduction:
 *
 *!!!!K\@(#)xneko.c	5.2m%0%i%`$O Macintosh $N5/22/919%/%"%/%;%5%j!< "neko" $N
 *!!F0:n$r X11 $G%^%M$?$b$N$G$9!#
 *
 *!!!!Macintosh "neko" $N=(0o$J5/22/916%$%s$K7I0U$rI=$7$D$D!"$3$N
 ...
 *	disco	!D!!X11 ./games/xneko/SCCS/s.xneko.c/%K%+%k!&%"5.2P%$%6!<
 *
 *	HOMY	!D!!/more/archive/CSRG/src/games/xneko/SCCS/s.xneko.c0;XE&<T
 ...
 *!!!!!!!!IaDL$O exit() ;~$K%7%9./games/xneko/SCCS/s.xneko.c`$,M>J,$J%j%=!<%9$r2rJ|$7$F
 *!!!!!!!!$/$l$^$9$,!"#O#S$K/more/archive/CSRG/src/games/xneko/SCCS/s.xneko.c0$,$"$k>l9g$O xneko $r2?EY$b5/
 *!!!!!!!!F0$9$k$H!"$=$N$&$A%9%o82WNN0h$,ITB-$7$F$7$^$&$3$H$K
 *!!!!!!!!$J$k$+$b$7$l$^$;$s!#
 *
 *!!!!!J#6!K;~4V$KF14|$7$FI,$:IA2h=hM}$r<B9T$9$k$?$a!"0BDj>uBV
 *!!!!!!!!$G$b Idle 90 !A 95% $H$J$j!"%7%9./games/xneko/SCCS/s.xneko.c`#C#P#U$r 5 !A 10%
 ...
 *!!System (Machine):
 *
 *!!!!K\@(#)xneko.c	5.2m%0%i%`$NF0:n$r3NG'$7$?%7%9./games/xneko/SCCS/s.xneko.c`9=@.$O0J2<$NDL$j!#
 *
...
/*
 *	X11 G- 0C11/15/19^129W13:03:18!%$%k0lMw!'
 *
 *		"icon.xbm"		!D!!%"%$%3%s
 *		"cursor.xbm"		!D!!%+!<%=%k
...
#define	BITMAP_WIDTH		32	/* #1%-%c%i%/%?$NI} (15:29:50/%;%k) */
#define	BITMAP_HEIGHT		32	/* #1%-%c%i%/%?$N9b$5 (15:29:50/%;%k) */

#define	WINDOW_WIDTH		320	/* %&%#%s5.2&$NI} (15:29:50/%;%k) */
#define	WINDOW_HEIGHT		256	/* %&%#%s5.2&$N9b$5 (15:29:50/%;%k) */
...
#define	INTERVAL		125000L		/* %$%s%?!</more/archive/CSRG/src/games/xneko/SCCS/s.xneko.ck%?%$%` */
...
/*
 *	%0%m!</more/archive/CSRG/src/games/xneko/SCCS/s.xneko.ckJQ?t
 */
...
/*--------------------------------------------------------------
 *
 *	%$%s%?!</more/archive/CSRG/src/games/xneko/SCCS/s.xneko.ck
 *
...
/*--------------------------------------------------------------
 *
 *	./games/xneko/SCCS/s.xneko.c#728/%+%&%s%H=hM}
 *
 *--------------------------------------------------------------*/
...
/*--------------------------------------------------------------
 *
 *	G-0\F0./games/xneko/SCCS/s.xneko.c9%H!J5/22/91P14670MQ!K
 *
 *--------------------------------------------------------------*/
...
NekoMoveTest()
{
    ...
    fprintf( stderr, "\n" );
    fprintf( stderr, "G-$N0\F0./games/xneko/SCCS/s.xneko.c9%H$r9T$$$^$9!#(Quit !D Alt-Q)\n" );
    fprintf( stderr, "\n" );
    fprintf( stderr, "\t%-!<C%I>e$N./games/xneko/SCCS/s.xneko.cs%-!<$GG-$r0\F0$5$;$F2<$5$$!#\n" );
...
ProcessDebugMenu()
{
    ...
    fprintf( stderr, "\n" );
    fprintf( stderr, "!Zxneko 5/22/91P15280%a%K%e!<![\n" );

    while ( !( UserSelectNo >= 1 && UserSelectNo <= 2 ) ) {
	fprintf( stderr, "\n" );
	fprintf( stderr, "\t1)!!G-%-%c%i%/%?!<0lMwI=<(\n" );
	fprintf( stderr, "\t2)!!G-0\F0./games/xneko/SCCS/s.xneko.c9%H\n" );
	fprintf( stderr, "\n" );
	...
	break;
    case 2:
	/* G-0\F0./games/xneko/SCCS/s.xneko.c9%H */
	NekoMoveTest();
	break;
    default:
	/* Internal Error */
    ...
    fprintf( stderr, "./games/xneko/SCCS/s.xneko.c9%H=*N;!#\n" );
    fprintf( stderr, "\n" );
}

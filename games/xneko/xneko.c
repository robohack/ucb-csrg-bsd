 ...
 *!!Introduction:
 *
 *!!!!K\@(#)xneko.c	5.1m%0%i%`$O Macintosh $N5/22/919%/%"%/%;%5%j!< "neko" $N
 ...
 *	disco	!D!!X11 ./games/xneko/SCCS/s.xneko.c/%K%+%k!&%"5.1P%$%6!<
 *
 ...
 *!!System (Machine):
 *
 *!!!!K\@(#)xneko.c	5.1m%0%i%`$NF0:n$r3NG'$7$?%7%9./games/xneko/SCCS/s.xneko.c`9=@.$O0J2<$NDL$j!#
 *
...
/*
 *	X11 G- 0C11/15/19^112W12:21:40!%$%k0lMw!'
 *
 *		"icon.xbm"		!D!!%"%$%3%s
 *		"cursor.xbm"		!D!!%+!<%=%k
...
#define	WINDOW_WIDTH		320	/* %&%#%s5.1&$NI} (15:29:50/%;%k) */
#define	WINDOW_HEIGHT		256	/* %&%#%s5.1&$N9b$5 (15:29:50/%;%k) */
...
/*--------------------------------------------------------------
 *
 *	./games/xneko/SCCS/s.xneko.c#711/%+%&%s%H=hM}
 *
 *--------------------------------------------------------------*/
...
/*--------------------------------------------------------------
 *
 *	G-0\F0./games/xneko/SCCS/s.xneko.c9%H!J5/22/91P14500MQ!K
 *
 *--------------------------------------------------------------*/
...
ProcessDebugMenu()
{
    ...
    fprintf( stderr, "\n" );
    fprintf( stderr, "!Zxneko 5/22/91P15110%a%K%e!<![\n" );

...
#ifndef lint
#ifdef NEWDB
static char sccsid[] = "@(#)alias.c	5.33 (Berkeley) 5/29/92 (with NEWDB)";
#else
#ifdef DBM
static char sccsid[] = "@(#)alias.c	5.33 (Berkeley) 5/29/92 (with DBM)";
#else
static char sccsid[] = "@(#)alias.c	5.33 (Berkeley) 5/29/92 (without DBM)";
#endif
#endif
#endif /* not lint */
/*

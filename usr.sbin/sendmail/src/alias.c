...
#ifndef lint
#ifdef NEWDB
static char sccsid[] = "@(#)alias.c	5.32 (Berkeley) 3/20/92 (with NEWDB)";
#else
#ifdef DBM
static char sccsid[] = "@(#)alias.c	5.32 (Berkeley) 3/20/92 (with DBM)";
#else
static char sccsid[] = "@(#)alias.c	5.32 (Berkeley) 3/20/92 (without DBM)";
#endif
#endif
#endif /* not lint */
/*

...
#ifdef NEWDB
#ifdef NDBM
static char sccsid[] = "@(#)alias.c	6.13 (Berkeley) 2/19/93 (with NEWDB and NDBM)";
#else
static char sccsid[] = "@(#)alias.c	6.13 (Berkeley) 2/19/93 (with NEWDB)";
#endif
#else
#ifdef NDBM
static char sccsid[] = "@(#)alias.c	6.13 (Berkeley) 2/19/93 (with NDBM)";
#else
static char sccsid[] = "@(#)alias.c	6.13 (Berkeley) 2/19/93 (without NEWDB or NDBM)";
#endif
#endif
#endif /* not lint */
/*

...
#ifndef lint
#ifdef DBM
static char sccsid[] = "@(#)alias.c	5.23 (Berkeley) 7/26/91 (with DBM)";
#else
#ifdef NEWDB
static char sccsid[] = "@(#)alias.c	5.23 (Berkeley) 7/26/91 (with NEWDB)";
#else
static char sccsid[] = "@(#)alias.c	5.23 (Berkeley) 7/26/91 (without DBM)";
#endif
#endif
#endif /* not lint */

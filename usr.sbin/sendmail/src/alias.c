...
#ifndef lint
#ifdef NEWDB
static char sccsid[] = "@(#)alias.c	6.3 (Berkeley) 1/9/93 (with NEWDB)";
#else
#ifdef NDBM
static char sccsid[] = "@(#)alias.c	6.3 (Berkeley) 1/9/93 (with NDBM)";
#else
static char sccsid[] = "@(#)alias.c	6.3 (Berkeley) 1/9/93 (without NDBM)";
#endif
#endif
#endif /* not lint */
/*

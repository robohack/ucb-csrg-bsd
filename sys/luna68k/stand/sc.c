	...
	unsigned len;
{
	...
	/* %;%s%9%G!<%?$N#8/more/archive/CSRG/src/sys/luna68k/stand/SCCS/s.sc.c$%HL\$NAddtional Sens Length$K$h$jF0E*$K7hDj$9$k!#*/
	/* $3$3$G$O%G!<%?!<E>Aw?t$rcdb$NAllocation Length$K:GDcD9$G$"$k#8/more/archive/CSRG/src/sys/luna68k/stand/SCCS/s.sc.c$%H */
